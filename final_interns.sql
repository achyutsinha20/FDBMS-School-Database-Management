...
CREATE TABLE `interns` (
  ...
  UNIQUE KEY `Level_UNIQUE` (`InternID`),
  KEY `PersonID_idx` (`PersonID`),
  CONSTRAINT `FK_Interns_PersonID` FOREIGN KEY (`PersonID`) REFERENCES `person` (`PersonID`)
...
INSERT INTO `interns` VALUES (1,21,15),(2,22,15),(3,23,11);
