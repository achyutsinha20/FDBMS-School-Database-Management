...
INSERT INTO `Final`.`Teacher` (`TeacherID`, `TeacherTitle`, `TeacherSalary`, `TeacherName`, `PersonID`) VALUES (6, 'Professor Of Computer Science', 60000, 'Mary George', 6);
INSERT INTO `Final`.`Teacher` (`TeacherID`, `TeacherTitle`, `TeacherSalary`, `TeacherName`, `PersonID`) VALUES (7, 'Professor Of Mathematics', 60000, 'June Walkters', 7);
INSERT INTO `Final`.`Teacher` (`TeacherID`, `TeacherTitle`, `TeacherSalary`, `TeacherName`, `PersonID`) VALUES (8, 'Professor Of English', 60000, 'Angela Mendez', 8);
INSERT INTO `Final`.`Teacher` (`TeacherID`, `TeacherTitle`, `TeacherSalary`, `TeacherName`, `PersonID`) VALUES (9, 'Professor Of Accounting', 60000, 'John Leak', 9);
INSERT INTO `Final`.`Teacher` (`TeacherID`, `TeacherTitle`, `TeacherSalary`, `TeacherName`, `PersonID`) VALUES (10, 'Professor Of Life Sciences', 60000, 'Carey Cochran', 10);
